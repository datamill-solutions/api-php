...
# **extractHouseNumber**
> \Swagger\Client\Model\AddressHouseNumberExtractResponse extractHouseNumber($license, $guid, $street, $housenumber)
...
[**\Swagger\Client\Model\AddressHouseNumberExtractResponse**](../Model/AddressHouseNumberExtractResponse.md)
...
# **locateAddress**
> \Swagger\Client\Model\AddressSearchResponse locateAddress($license, $guid, $latitude, $longitude, $locale)
...
[**\Swagger\Client\Model\AddressSearchResponse**](../Model/AddressSearchResponse.md)
...
# **searchAddress**
> \Swagger\Client\Model\AddressSearchResponse searchAddress($license, $guid, $address, $country, $state, $county, $city, $zip, $district, $street, $housenumber, $locale)
...
> \Swagger\Client\Model\AddressSearchMultipleResponse searchAddressMultiple($license, $guid, $address, $locale)
...
[**\Swagger\Client\Model\AddressSearchMultipleResponse**](../Model/AddressSearchMultipleResponse.md)
