...
# **getDUNSRating**
> \Swagger\Client\Model\BusinessDataDunsRatingResponse getDUNSRating($license, $guid, $duns_number, $reason_code)
...
$api_instance = new Swagger\Client\Api\DUNSApi();
...
[**\Swagger\Client\Model\BusinessDataDunsRatingResponse**](../Model/BusinessDataDunsRatingResponse.md)
...
# **resolveDUNS**
> \Swagger\Client\Model\BusinessDataDunsResolveResponse resolveDUNS($license, $guid, $duns_number, $reason_code)
...
[**\Swagger\Client\Model\BusinessDataDunsResolveResponse**](../Model/BusinessDataDunsResolveResponse.md)
...
# **searchDUNS**
> \Swagger\Client\Model\BusinessDataDunsSearchResponse searchDUNS($license, $guid, $country_code, $company_name, $duns_number, $state, $city, $zip, $street)
...
[**\Swagger\Client\Model\BusinessDataDunsSearchResponse**](../Model/BusinessDataDunsSearchResponse.md)
