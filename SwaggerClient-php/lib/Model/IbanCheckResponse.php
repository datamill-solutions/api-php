...
/**
 * IbanCheckResponse Class Doc Comment
 *
 * @category    Class */
 // @description Response of successful transformation request for /iban/check
/**
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache License v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IbanCheckResponse implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'IbanCheckResponse';
    ...
    /**
     * Sets valid
     * @param string $valid Either '1' if IBAN is valid otherwise '0'
     * @return $this
     */
    ...
    /**
     * Sets iban
     * @param string $iban The formatted IBAN
     * @return $this
     */
