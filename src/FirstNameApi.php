...
class FirstNameApi
{
     ...
     * @param string $name Full name to detect all first names and extract them (required)
     * @throws \DataMill\ApiException on non-2xx response
     * @return array of \\FirstNameGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFirstNamesWithHttpInfo($license, $guid, $name)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\\FirstNameGetResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\\FirstNameGetResponse', $e->getResponseHeaders());
