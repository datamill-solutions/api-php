<?php
/**
 * SocialMediaActivitiesGetLinkedIn
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * SocialMediaActivitiesGetLinkedIn Class Doc Comment
 *
 * @category    Class */
 // @description LinkedIn information for /social-media/activities/get
/**
 * @package     DataMill
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache License v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SocialMediaActivitiesGetLinkedIn implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'SocialMediaActivitiesGet_LinkedIn';
    ...
    /**
     * Sets bio
     * @param string $bio The person's biography written on LinkedIn
     * @return $this
     */
    ...
    /**
     * Sets followers
     * @param int $followers The number of followers on LinkedIn
     * @return $this
     */
